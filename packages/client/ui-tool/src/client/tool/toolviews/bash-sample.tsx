...
import { toolRowModel, localizeToolTitle, type ToolRowState } from '../models/tool-call-model.ts'
  ...
  return (
    <div className={css.card}>
      ...
      >
        ...
        <span className={css.title}>{localizeToolTitle(t, model.variant, model.title)}</span>
