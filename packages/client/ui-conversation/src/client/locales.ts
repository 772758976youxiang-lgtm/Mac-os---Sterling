...
export const zh = {
  ...
  'image.unsupportedType': '仅支持 PNG、JPG、WebP、GIF、AVIF、HEIC/HEIF 格式的图片',
  ...
  'settings.contextInjection.title': '显示上下文注入',
  'settings.contextInjection.description': '仅控制会话记录中的显示，不影响模型接收的上下文',
  'settings.toolCalls.title': '显示工具调用',
  'settings.toolCalls.description': '关闭后隐藏会话中的工具调用记录（如 MCP 工具），模型行为不受影响',
  'settings.thinking.title': '显示思考过程',
  'settings.thinking.description': '关闭后隐藏智能体的思考过程记录，模型行为不受影响',
  ...
  'command.done': '已完成',
  'command.title': '命令',
  'command.permission.title': '权限',
  'command.permission.preset': '预设 {name}',
  'command.permission.current': '当前预设 {current}（可用：{available}）',
  'command.permission.unknown': '未知预设 "{name}"（可用：{available}）',
  'command.permission.listSeparator': '、',
...
export const en = {
  ...
  'image.unsupportedType': 'Only PNG, JPG, WebP, GIF, AVIF, and HEIC/HEIF images are supported',
  ...
  'settings.contextInjection.title': 'Show context injections',
  'settings.contextInjection.description': 'Only changes the transcript display; model context is unaffected',
  'settings.toolCalls.title': 'Show tool calls',
  'settings.toolCalls.description': 'Hides tool-call rows (such as MCP tools) from the transcript when off; model behavior is unaffected',
  'settings.thinking.title': 'Show thinking process',
  'settings.thinking.description': 'Hides the assistant reasoning rows from the transcript when off; model behavior is unaffected',
  ...
  'hero.headline': 'Know what you want, make it happen',
  ...
  'command.permission.title': 'Permission',
  'command.permission.preset': 'preset {name}',
  'command.permission.current': 'Current preset {current} (available: {available})',
  'command.permission.unknown': 'Unknown preset "{name}" (available: {available})',
  'command.permission.listSeparator': ', ',
