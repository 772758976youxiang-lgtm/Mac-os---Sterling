...
export const en = {
  ...
  modelInput: 'Input modality',
  modelInputAuto: 'Automatic',
  modelInputText: 'Text only',
  modelInputImage: 'Text + image',
  candidateImageInput: 'Image input detected',
  candidateTextInput: 'Text input detected',
  candidateReasoningLevels: '{count} reasoning levels',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelInputAuto: '自动',
  modelInputText: '仅文本',
  modelInputImage: '文本 + 图片',
  candidateImageInput: '已检测支持图片',
  candidateTextInput: '已检测仅文本',
  candidateReasoningLevels: '已检测 {count} 个思考档位',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
