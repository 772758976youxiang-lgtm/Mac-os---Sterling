...
Source: [`packages/session/email-digest/src/types.ts:45`](../packages/session/email-digest/src/types.ts)
...
Source: [`packages/schedule/schedule/src/types.ts:237`](../packages/schedule/schedule/src/types.ts)
