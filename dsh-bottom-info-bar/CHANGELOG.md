...
- 按当前模型 provider 路由查询余额；DeepSeek 与 Rayplus 自动适配，每条路由使用自己的凭据引用
- `DSH_BOTTOM_INFO_BAR_BALANCE_ADAPTERS` 自定义余额接口配置，支持 DeepSeek、Rayplus 与字段路径三种响应解析
- 未提供余额 API 的平台显示明确的不支持状态，不再回退到其他服务商或虚构充值额

### Unchanged

- ChatGPT/Codex 与 OpenCode Go 继续使用原有订阅额度窗口，两条订阅数据源与余额模式保持互斥
...
[1.0.0]: https://github.com/772758976youxiang-lgtm/Sterling-Harness-win--/releases/tag/v1.0.0
